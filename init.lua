...
local function RGInit(...)
    ...
    printf("\aw****************************")
    printf("\agDefault Configs have been updated on 4/13/2025:")
    printf("\agDruid Laz Beta is now the default config!")
    printf("\agWizard Live Beta is now the default config!")
